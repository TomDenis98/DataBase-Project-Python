...
#fills the values with database
def Addgrades(studentnumber):
    ...
    for course in courselist:
        ...
        studentTree.place(x=50, y=100, height=500, width=650)

        lblTitle = Label(root, text="Grades of {}".format(firstname[0][0]), font=('Arial', '30', 'bold'), bg='deeppink', fg="white", width=20)
...
btnGrades = Button(root, text="Grades", font=("Helvetica", 10), bg="deep pink", fg="white", activebackground='deeppink',width=10)
