...
# Get the studentnumber for 'travelling' between pages --------
...
def Disclaimer():
    ...
    discbg = Label(root, text=" ", width=500, height=500, bg='deep pink').place(x=0,y=0)
    
    lblTitle = Label(root, text="Disclaimer", font=('Arial', '30', 'bold'), bg='deeppink', fg="white")
    ...
    btnExit = Button(root, text="Exit", font=("Helvetica", 10), bg="grey", fg="white", activebackground='deeppink', width=10,command=Exit)
...
def Privacy():
    ...
    lblTitle = Label(root, text="Privacy Statement", font=('Arial', '30', 'bold'), bg='deeppink', fg="white")
...
def OpenProfile():
    root.destroy()
    subprocess.Popen([sys.executable, 'Profile.py', studentnumber])
...
lblTitle = Label(root, text="Settings", font=('Arial', '30', 'bold'), bg='deeppink', fg="white")
...
# Page buttons ------------------------------------------------------------
btnProfile = Button(root, text="My Profile", font=("Helvetica", 10), bg="grey", fg="white",activebackground='deeppink', width=10, command=OpenProfile)  
btnProfile.place(x=100, y=400)
...
btnGrades.place(x=200, y=400)
btnSettings= Button(root, text="Settings", font=("Helvetica", 10), bg="deeppink", fg="white", activebackground='deeppink',width=10) #no command, current page
btnSettings.place(x=300, y=400)

# Settingsbuttons --------------------------------
btnDisclaimer= Button(root, text="Disclaimer", font=("Helvetica", 15), bg="grey", fg="white", activebackground='deeppink',width=20,command=Disclaimer)
btnDisclaimer.place(x=130, y=125)
btnPrivacy = Button(root, text="Privacy statement", font=("Helvetica", 15), bg="grey", fg="white",activebackground='deeppink', width=20,command=Privacy)
